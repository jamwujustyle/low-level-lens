...
2. **Computer Architecture (COSC 3510)**: A web-based "Slow Motion CPU" UI built in Vanilla JS/TS that visualizes the Fetch-Decode-Execute cycle, demonstrating how software touches the hardware.
...
- **Visual Hardware Emulator (Vanilla JS/TS)**: A dashboard to step through the execution pipeline, visualizing data movement across buses and logic gates inside the ALU.
<!-- REDESIGN NOTE: STEP EXECUTION | HUMAN PACED CONTINUOUS -->

## 🛠️ Tech Stack

- **Backend / Compiler / VCPU**: Go
- **Frontend / Visualization**: Vanilla JS/TS, HTML, Tailwind CSS
